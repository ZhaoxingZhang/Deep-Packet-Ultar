...
这些理论分析不仅解释了实验结果，也为GEE架构的成功提供了深刻的理论洞察。GEE架构通过统一的数学框架（加权损失+门控融合）同时解决了少数类识别和开放集识别两大问题：加权损失平衡了梯度贡献，门控网络实现了智能融合。这使得GEE在少数类识别任务上Macro-F1从0.63提升至0.83，在开放集识别任务上FPR@TPR95从0.47降至0.03。
