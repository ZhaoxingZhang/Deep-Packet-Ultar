...
# ==================================================================================
# Incremental Learning GEE (ResNet) - traffic_v2 Dataset
# ==================================================================================

# Config
DATA_SOURCE="processed_data/traffic_v2"
BASE_DIR="train_test_data/exp_traffic_v2/incremental/gee_resnet"
MODEL_DIR="model/exp_traffic_v2/incremental/gee_resnet"
EVAL_DIR="evaluation_results/exp_traffic_v2/incremental/gee_resnet"

# Classes 5 8 are treated as "Minority/Expert" classes
MINORITY_CLASSES="5 8"
MINORITY_CLASSES_ARGS=" --minority-classes 5 --minority-classes 8"
MINORITY_CLASSES_ARGS_US=" --minority_classes 5 --minority_classes 8"
