...
# ==================================================================================
# Open Set Recognition Baseline (ResNet) - traffic_v2 Dataset (6-fold)
# ==================================================================================

DATA_SOURCE="processed_data/traffic_v2"
ALL_CLASSES="0 2 4 5 6 8"

BASE_DIR="train_test_data/exp_traffic_v2/openset/baseline_resnet"
MODEL_DIR="model/exp_traffic_v2/openset/baseline_resnet"
EVAL_DIR="evaluation_results/exp_traffic_v2/openset/baseline_resnet"
