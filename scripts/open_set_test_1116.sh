...
do
  ...
  conda run -n deep_packet python create_train_test_set.py \
    -s /Users/weisman/Documents/repo_root/graduate/Deep-Packet-Ultar/processed_data/vpn \
    -t "${TARGET_DIR}" \
  ...
  conda run -n deep_packet python train_resnet.py \
    --data_path "${DATA_PATH}" \
