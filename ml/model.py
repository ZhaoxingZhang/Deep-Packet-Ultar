...
@startuml
 ...
 title ResNet Class Architecture
 ...
 package "ml.model" {
     ...
     class ResNet extends LightningModule {
         + conv1: Sequential
         + max_pool: MaxPool1d
         + fc1: Sequential
         + fc2: Sequential
     ...
     class ResNet1d extends Module {
         + first_block_conv: CustomConv1d
         + first_block_bn: BatchNorm1d
     ...
     class BasicBlock extends Module {
         ...
         + do2: Dropout
         + conv2: CustomConv1d
         + max_pool: CustomMaxPool1d
         --
         + forward(x)
     }

     class CustomConv1d extends Module {
        + conv: Conv1d
        --
        + forward(x)
     }

     class CustomMaxPool1d extends Module {
         + max_pool: MaxPool1d
         --
         + forward(x)
     }
 ...
 ResNet "1" o-- "1" ResNet1d : wraps
 ResNet1d "1" *-- "n" BasicBlock : contains in ModuleList
 BasicBlock "1" *-- "2" CustomConv1d : contains
 BasicBlock "1" *-- "1" CustomMaxPool1d : contains for downsampling
