...
# ==================================================================================
# Incremental Learning GEE (ResNet) - traffic_v3 Dataset
# ==================================================================================

# Config
DATA_SOURCE="processed_data/traffic_v3"
BASE_DIR="train_test_data/exp_traffic_v3/incremental/gee_resnet"
MODEL_DIR="model/exp_traffic_v3/incremental/gee_resnet"
EVAL_DIR="evaluation_results/exp_traffic_v3/incremental/gee_resnet"

# Classes 7 9 are treated as "Minority/Expert" classes
MINORITY_CLASSES="7 9"
MINORITY_CLASSES_ARGS=" --minority-classes 7 --minority-classes 9"
MINORITY_CLASSES_ARGS_US=" --minority_classes 7 --minority_classes 9"
