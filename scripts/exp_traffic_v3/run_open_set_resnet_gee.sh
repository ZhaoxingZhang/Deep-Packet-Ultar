...
# ==================================================================================
# Open Set Recognition GEE (ResNet) - traffic_v3 Dataset (6-fold)
# ==================================================================================

DATA_SOURCE="processed_data/traffic_v3"
ALL_CLASSES="0 2 4 7 9 10"
MINORITY_CANDIDATES="7 9"

BASE_DIR="train_test_data/exp_traffic_v3/openset/gee_resnet"
MODEL_DIR="model/exp_traffic_v3/openset/gee_resnet"
EVAL_DIR="evaluation_results/exp_traffic_v3/openset/gee_resnet"
