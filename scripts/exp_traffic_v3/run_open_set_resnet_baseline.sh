...
# ==================================================================================
# Open Set Recognition Baseline (ResNet) - traffic_v3 Dataset (6-fold)
# ==================================================================================

DATA_SOURCE="processed_data/traffic_v3"
ALL_CLASSES="0 2 4 7 9 10"

BASE_DIR="train_test_data/exp_traffic_v3/openset/baseline_resnet"
MODEL_DIR="model/exp_traffic_v3/openset/baseline_resnet"
EVAL_DIR="evaluation_results/exp_traffic_v3/openset/baseline_resnet"
